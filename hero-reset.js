...
if(isHome){
  ...
  resetCopy();setTimeout(resetCopy,250);setTimeout(resetCopy,1200);
  window.addEventListener('stellaris:languagechange',event=>{if(event.detail?.language==='ko')setTimeout(resetCopy,0);});
}
